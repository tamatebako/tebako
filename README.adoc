...
image:https://github.com/tamatebako/tebako/actions/workflows/windows-msys.yml/badge.svg["Windows-MSys(limited)", link="https://github.com/tamatebako/tebako/actions/workflows/windows-msys.yml"]
